...
- Having a fundamental grasp on Assembly , C , Lisp and Haskell. Planning on learning Kotlin to grasp the sweet oops concept while creating something neat 
...
- Working on the Electronic Arts Software Engineering Virtual Experience to brush up basics on c++ and python and possibly make a simple indie game with unity engine

- Contributing to open source adding things I have learned every day to my own personal repo as well as an open source project to help form a habit

- Will be taking a crash course on Design // visual and aesthetics , User Interface ( UI ) , User experience design (UX) , Typography and stuff as part of the research project 
...
<img src="https://github.com/devicons/devicon/blob/master/icons/kotlin/kotlin-original.svg" width="115" hight="80"> &nbsp;
